...
<head>
    ...
    <title>Cabinet Dentaire Sourire Sain - Page Contact</title>
...
<body>
    ...
    <header>
        <a href="../index.html">
            <img src="../img/logo.png" alt="Logo du cabinet">
        </a>
        <ul>
            ...
            <li><a href="contact.php" alt="Pour rediriger vers la page contact">Contact</a></li>
        </ul>
    </header>
    <!-- Header -->
